...
var Hashtag = function (_React$Component) {
  ...
  function Hashtag() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(Hashtag).apply(this, arguments));
  }
  ...
  _createClass(Hashtag, [{
    ...
    value: function ready(tw, element, done) {
      ...
      tw.widgets.createHashtagButton(hashtag, element, (0, _lodash4.default)(options)).then(function () {
        // Widget is loaded
        done();
        onLoad();
      });
