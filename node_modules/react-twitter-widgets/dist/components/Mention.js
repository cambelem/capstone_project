...
var Mention = function (_React$Component) {
  ...
  function Mention() {
    ...
    return _possibleConstructorReturn(this, Object.getPrototypeOf(Mention).apply(this, arguments));
  }
  ...
  _createClass(Mention, [{
    ...
    value: function ready(tw, element, done) {
      ...
      tw.widgets.createMentionButton(username, element, (0, _lodash4.default)(options)).then(function () {
        // Widget is loaded
        done();
        onLoad();
      });
